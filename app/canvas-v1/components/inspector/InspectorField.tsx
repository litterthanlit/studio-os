 ...
 *
 * Design system:
 * - Two-column layout: label left (Geist Sans 11px #6B6B6B), value right (Geist Mono 11px #1A1A1A)
...
export function InspectorTextInput({
  ...
  return (
    <input
      ...
      {...props}
      className={cn(
        "w-full min-h-6 border border-[#E8E8E8] dark:border-[#333333] rounded-md bg-[#F3F3F3] dark:bg-[#2A2A2A] px-2 py-0 font-mono text-[11px] text-[#1A1A1A] dark:text-[#D0D0D0] placeholder:text-[#A0A0A0] dark:placeholder:text-[#555555] outline-none transition-colors focus:border-[#4B57DB] focus:ring-1 focus:ring-[#4B57DB]/20",
        className
      )}
    />
  );
...
export function InspectorTextarea({
  ...
  return (
    <textarea
      ...
      className={cn(
        "w-full border border-[#E8E8E8] dark:border-[#333333] rounded-md bg-[#F3F3F3] dark:bg-[#2A2A2A] px-2 py-1 font-mono text-[11px] text-[#1A1A1A] dark:text-[#D0D0D0] placeholder:text-[#A0A0A0] dark:placeholder:text-[#555555] outline-none transition-colors resize-none min-h-[56px] focus:border-[#4B57DB] focus:ring-1 focus:ring-[#4B57DB]/20",
        className
      )}
    />
  );
  ...
  return (
    <div className="relative flex items-center">
      <input
        ...
        className={cn(
          "w-full min-h-6 text-left border border-[#E8E8E8] dark:border-[#333333] rounded-md bg-[#F3F3F3] dark:bg-[#2A2A2A] px-2 py-0 pr-6 font-mono text-[11px] text-[#1A1A1A] dark:text-[#D0D0D0] outline-none transition-colors focus:border-[#4B57DB] focus:ring-1 focus:ring-[#4B57DB]/20 [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none",
  ...
  return (
    <div className="relative">
      <select
        {...props}
        className={cn(
          "w-full min-h-6 appearance-none border border-[#E8E8E8] dark:border-[#333333] rounded-md bg-[#F3F3F3] dark:bg-[#2A2A2A] px-2 py-0 pr-7 font-mono text-[11px] text-[#1A1A1A] dark:text-[#D0D0D0] outline-none transition-colors cursor-pointer focus:border-[#4B57DB] focus:ring-1 focus:ring-[#4B57DB]/20",
          className
        )}
      >
        {children}
  ...
  return (
    <div className="flex items-center gap-2">
        ...
        <button
          ...
          className={cn(
            ...
            isMixed
              ...
              : isEmpty
              ? "border-dashed border-[#E5E5E0] dark:border-[#333333] bg-[#F3F3F3] dark:bg-[#2A2A2A]"
              : "border-[#E5E5E0] dark:border-[#333333]"
          )}
      ...
      <input
        ...
        className={cn(
          "flex-1 min-h-6 border border-[#E8E8E8] dark:border-[#333333] rounded-md bg-[#F3F3F3] dark:bg-[#2A2A2A] px-2 py-0 font-mono text-[11px] text-[#1A1A1A] dark:text-[#D0D0D0] outline-none transition-colors focus:border-[#4B57DB] focus:ring-1 focus:ring-[#4B57DB]/20",
      ...
      <div className="relative w-14 shrink-0">
        <input
          ...
          className="w-full min-h-6 border border-[#E8E8E8] dark:border-[#333333] rounded-md bg-[#F3F3F3] dark:bg-[#2A2A2A] px-2 py-0 pr-4 font-mono text-[11px] text-[#1A1A1A] dark:text-[#D0D0D0] outline-none transition-colors focus:border-[#4B57DB] focus:ring-1 focus:ring-[#4B57DB]/20 text-right"
        />
    ...
    <div>
      ...
      <div className="flex items-center gap-2">
        ...
        <input
          ...
          className={cn(
            "w-[52px] h-6 text-center border border-[#E8E8E8] dark:border-[#333333] rounded-md bg-[#F3F3F3] dark:bg-[#2A2A2A] px-1.5 font-mono text-[11px] text-[#1A1A1A] dark:text-[#D0D0D0] outline-none transition-colors focus:border-[#4B57DB] focus:ring-1 focus:ring-[#4B57DB]/20 [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none shrink-0",
