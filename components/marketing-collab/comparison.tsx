  ...
  return (
    <section className="py-[180px] bg-[#FAFAF8] relative" id="comparison">
      ...
      <div className="grid grid-cols-[1fr_40px_1fr] max-w-[1040px] mx-auto px-10">
        {/* Generic Side */}
        <div
          className="rounded-lg overflow-hidden border border-[#EFEFEC]/50 bg-white opacity-75 saturate-[0.3]"
          data-reveal
        >
        ...
        {/* Taste Side */}
        <div
          className="rounded-lg overflow-hidden border border-[#4B57DB] bg-white shadow-[0_8px_40px_rgba(75,87,219,0.06)]"
          data-reveal
        >
...
function GenericCard({ title, desc }: { title: string; desc: string }) {
  return (
    <div className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-[4px] p-2.5">
      ...
      <h4 className="text-[8px] font-semibold text-[#6B7280] mb-[3px]">
        {title}
      </h4>
