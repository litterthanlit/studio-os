...
export function EngineeringSplit() {
  return (
    <section className="relative w-full overflow-hidden min-h-[600px] border-y border-[#0C0C14]/10 flex">
      ...
      <div className="w-full max-w-[1440px] mx-auto px-5 md:px-[80px] relative z-10 flex flex-col md:flex-row pointer-events-auto">
        ...
        <div className="w-full md:w-1/2 py-10 md:py-[80px] md:pr-10 flex flex-col justify-between">
          <div className="pt-10">
            <h2 className="font-['Noto_Serif'] font-medium text-white text-[32px] md:text-[42px] leading-tight mb-10 max-w-[300px]">
        ...
        <div className="w-full md:w-1/2 py-10 md:py-[80px] md:pl-10 relative">
          <h2 className="font-['Noto_Serif'] font-medium text-[#0C0C14] text-[32px] md:text-[42px] leading-tight mb-[40px] relative z-10">
