      ...
      <div className="max-w-[1120px] mx-auto px-10">
        <div className="grid grid-cols-[1fr_1.1fr] gap-14 items-center">
          ...
          <div data-reveal>
            ...
            <h2 className="text-[clamp(28px,3.5vw,40px)] font-medium tracking-[-0.02em] leading-[1.1] mb-3.5 mt-4 text-balance">
              Real code.
              <br />
          ...
          {/* Code Block */}
          <div
            className="bg-[#0D0D0D] rounded-lg overflow-hidden border border-[#2A2A2A]/50"
            data-reveal
          >
            <div className="flex items-center gap-1 px-3.5 py-2.5 border-b border-[#222]/50 bg-[#141414]">
              ...
              <div className="w-1.5 h-1.5 rounded-full bg-[#333]" />
              <div className="w-1.5 h-1.5 rounded-full bg-[#333]" />
              <span className="ml-auto font-mono text-[10px] text-[#4B57DB] cursor-pointer">
                Copy HTML
              </span>
            </div>
