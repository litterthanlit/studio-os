    ...
    <section className="py-[180px] bg-[#FAFAF8]" id="editor">
      <div className="max-w-[1120px] mx-auto px-10">
        ...
        <div className="grid grid-cols-2 gap-4">
          {/* Card 1: Canvas Feel */}
          <div
            className="bg-white border border-[#EFEFEC]/50 rounded-[6px] overflow-hidden transition-all duration-300 ease-[cubic-bezier(0.22,1.0,0.36,1.0)] hover:border-[#1E5DF2]/20 hover:-translate-y-1"
            data-reveal
          >
            <div className="h-[220px] bg-[#1A1A1A] flex items-center justify-center relative overflow-hidden">
              <div className="w-[75%] h-[75%] bg-[#FAFAF8] rounded-[3px] relative">
                ...
                <div className="absolute top-6 left-8 w-[130px] h-[90px] bg-white rounded-[2px] z-[1] shadow-[0_1px_4px_rgba(0,0,0,0.05)]">
                  <div className="absolute -top-3.5 left-0 font-mono text-[7px] text-[#1E5DF2]">
                    Hero — frame
                  </div>
                </div>
                <div className="absolute top-11 left-[100px] w-[90px] h-11 border border-dashed border-[#1E5DF2]/45" />
          ...
          >
            <div className="h-[220px] bg-[#1A1A1A] flex items-center justify-center relative overflow-hidden">
              <div className="w-[55%]">
                <div className="font-mono text-[7px] uppercase tracking-[1px] font-mono text-[#555] pb-1.5 border-b border-[#2A2A2A]/50 mb-1">
                  Layers
                </div>
            ...
            <div className="h-[220px] bg-[#FAFAF8] flex items-center justify-center relative overflow-hidden">
              <div className="text-center">
                <div className="flex gap-7 items-end justify-center mb-4">
                  <div className="text-center">
                    <div className="flex items-center justify-center w-[72px] h-[72px] bg-white rounded-[4px] border-[1.5px] border-[#1E5DF2] font-mono text-[11px] text-[#1E5DF2] mb-1.5">
                      Fill
                    </div>
...
function DarkInspRule({ label }: { label: string }) {
  return (
    <div className="flex items-center gap-1.5 mb-1.5">
      ...
      <span className="font-mono text-[7px] uppercase tracking-[1px] font-mono text-[#4A4A4A] whitespace-nowrap">
        {label}
      </span>
      <div className="flex-1 h-px bg-[#2A2A2A]" />
    </div>
    ...
    >
      <div
        className={`w-2 h-2 border rounded-[1px] ${
          selected ? "border-[#1E5DF2]" : "border-[#444]"
        }`}
      />
      {label}
    </div>
