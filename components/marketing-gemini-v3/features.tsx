...
export function Features() {
  return (
    <section className="w-full py-[120px] bg-[#FAFAF8]" id="features">
      <div className="max-w-[calc(100%-160px)] mx-auto w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[20px]" data-reveal>
          
          {/* Card 1 */}
          <div className="bg-white border border-[#1A1A1A]/5 rounded-[6px] p-6 flex flex-col justify-between aspect-square group relative overflow-hidden shadow-sm hover:-translate-y-1 transition-transform duration-300">
            <h3 className="font-['Bespoke_Serif'] text-[#1A1A1A] text-2xl leading-tight mb-4 z-10 w-[80%]">
            ...
            <div className="relative flex-grow flex items-end justify-center pb-4 z-10">
              <div className="w-[120%] h-[120px] bg-white border border-[#1A1A1A]/10 rounded-t-[6px] shadow-lg flex relative overflow-hidden left-4">
                 <div className="w-16 h-full border-r border-[#1A1A1A]/5 bg-[#FAFAF8]" />
            ...
            <p className="font-sans text-[#1A1A1A]/60 text-sm mt-4 z-10 w-[80%]">
          ...
          {/* Card 3 */}
          <div className="bg-[#1E5DF2] rounded-[6px] p-6 flex flex-col justify-between aspect-square relative overflow-hidden shadow-sm hover:-translate-y-1 transition-transform duration-300">
            <h3 className="font-['Bespoke_Serif'] text-white text-2xl leading-tight mb-4 z-10 w-[80%]">
              Intent,<br/>Mapped.
            </h3>
          ...
          {/* Card 4 */}
          <div className="bg-white border border-[#1A1A1A]/5 rounded-[6px] p-6 flex flex-col justify-between aspect-square relative overflow-hidden shadow-sm hover:-translate-y-1 transition-transform duration-300">
            <h3 className="font-['Bespoke_Serif'] text-[#1A1A1A] text-2xl leading-tight mb-4 z-10 w-[80%]">
            ...
            <div className="relative flex-grow flex items-center justify-center z-10">
               <div className="w-[140px] h-[100px] bg-white border border-[#1A1A1A]/10 rounded-[4px] overflow-hidden flex flex-col shadow-xl absolute rotate-2">
                 <div className="h-6 border-b border-[#1A1A1A]/5 flex items-center px-2 bg-[#FAFAF8]">
                   <div className="text-[7px] font-mono text-[#1A1A1A]/40 uppercase tracking-wider">Prompt</div>
                 </div>
                 <div className="p-3 flex-grow flex flex-col gap-2">
                   ...
                   <div className="bg-[#1A1A1A]/5 text-[#1A1A1A]/70 text-[8px] p-1.5 rounded-[4px] self-start max-w-[80%]">
                     Generating structure...
                   </div>
                   <div className="flex gap-1 mt-auto">
                     <div className="h-[2px] bg-[#FF7A59] flex-grow rounded-full animate-pulse" />
                     <div className="h-[2px] bg-[#1A1A1A]/10 flex-grow rounded-full" />
                   </div>
                 </div>
               </div>
            </div>

            <p className="font-sans text-[#1A1A1A]/60 text-sm mt-4 z-10 w-[90%]">
