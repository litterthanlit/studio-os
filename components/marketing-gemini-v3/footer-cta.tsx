  ...
  return (
    <section className="py-[200px] px-10 text-center relative">
      ...
      <div
        ...
        style={{
          background:
            "repeating-linear-gradient(90deg, #1E5DF2 0px, #1E5DF2 3px, transparent 3px, transparent 5px)",
      ...
      <h2
        className="text-[clamp(36px,5vw,56px)] font-['Bespoke_Serif'] font-medium tracking-[-0.03em] leading-[1.0] mb-5 text-balance"
        data-reveal
      >
        Your taste.
        <br />
        <span className="text-[#1E5DF2] italic">Amplified.</span>
      </h2>
      <p
