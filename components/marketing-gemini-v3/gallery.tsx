        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <GalCard tag="Swiss" desc="From International Typographic Style refs">
            <div className="h-[40%] bg-white p-3.5 border-b-2 border-[#111] flex flex-col justify-end">
              <div className="text-[15px] font-medium text-[#111] tracking-[-0.03em] leading-none">
                Form
                <br />
                follows
                <br />
            ...
            <div className="px-3.5 py-2">
              ...
              <div className="h-[3px] w-5 bg-[#1E5DF2] mt-1.5" />
            </div>
          </GalCard>
        </div>
      </div>
...
function GalCard({
  ...
  return (
    <div
      className="border border-[#EFEFEC]/50 rounded-[6px] overflow-hidden bg-white cursor-pointer transition-all duration-300 ease-[cubic-bezier(0.22,1.0,0.36,1.0)] hover:border-[#1E5DF2]/25 hover:-translate-y-1 active:-translate-y-px active:scale-[0.99]"
      data-reveal=""
    >
      ...
      <div className="px-4 py-3.5">
        <div className="inline-block font-mono text-[9px] uppercase tracking-[1px] font-mono text-[#1E5DF2] bg-[#EDF1FE] px-2 py-[3px] rounded-[2px] mb-1.5">
          {tag}
        </div>
