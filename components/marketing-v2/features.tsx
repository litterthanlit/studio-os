    ...
    <section className="w-full py-[120px] bg-[#FAFAFA]" id="features">
      <div className="w-full max-w-[1440px] px-5 md:px-[80px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[20px]">
          ...
          {/* Card 1 */}
          <div className="bg-white border border-[#0C0C14]/5 rounded-[4px] p-6 flex flex-col justify-between aspect-square group relative overflow-hidden">
            <h3 className="font-['Noto_Serif'] text-[#0C0C14] text-2xl leading-tight mb-4 z-10 w-[80%]">
            ...
            <div className="relative flex-grow flex items-end justify-center pb-4 z-10">
              <div className="w-[120%] h-[120px] bg-white border border-[#0C0C14]/10 rounded-t-md shadow-lg flex relative overflow-hidden left-4">
                 <div className="w-16 h-full border-r border-[#0C0C14]/5 bg-[#FAFAFA]" />
            ...
            <p className="font-sans text-[#0C0C14]/60 text-sm mt-4 z-10 w-[80%]">
            ...
            <div className="relative flex-grow flex items-center justify-center z-10">
              <div className="flex items-center gap-4">
                <div className="flex flex-col gap-2">
                  <div className="h-0.5 w-6 bg-[#4B57DB]/40" />
                  <div className="h-0.5 w-8 bg-[#4B57DB]/40" />
                  <div className="h-0.5 w-6 bg-[#4B57DB]/40" />
                </div>
                <div className="border border-[#4B57DB] bg-[#4B57DB]/5 rounded text-[#4B57DB] font-mono text-[10px] py-1.5 px-3 flex items-center justify-center shadow-sm font-medium">
                  DesignNode
                </div>
                <div className="flex flex-col gap-2">
                  ...
                  <div className="h-0.5 w-8 relative bg-[#4B57DB]/40"><div className="absolute right-0 top-1/2 -translate-y-1/2 w-1.5 h-1.5 rounded-full bg-[#4B57DB] border border-[#D1E4FC]" /></div>
                </div>
              </div>
            </div>

            <p className="font-sans text-[#0C0C14]/70 text-sm mt-4 z-10 w-[90%]">
          ...
          <div className="bg-[#4B57DB] rounded-[4px] p-6 flex flex-col justify-between aspect-square relative overflow-hidden">
            <h3 className="font-['Noto_Serif'] text-white text-2xl leading-tight mb-4 z-10 w-[80%]">
              Intent,<br/>Mapped.
            </h3>
              ...
              <div className="relative w-full h-full flex items-center justify-center">
                 ...
                 <div className="absolute w-full h-full">
                    <svg width="100%" height="100%" viewBox="0 0 200 200" className="overflow-visible absolute top-0 left-0">
                      ...
                      <circle cx="80" cy="120" r="3" fill="#0C0C14" />
                      <circle cx="100" cy="60" r="3" fill="#0C0C14" />
          ...
          {/* Card 4 */}
          <div className="bg-white border border-[#0C0C14]/5 rounded-[4px] p-6 flex flex-col justify-between aspect-square relative overflow-hidden">
            <h3 className="font-['Noto_Serif'] text-[#0C0C14] text-2xl leading-tight mb-4 z-10 w-[80%]">
            ...
            <div className="relative flex-grow flex items-center justify-center z-10">
               <div className="w-[140px] h-[100px] bg-white border border-[#0C0C14]/10 rounded overflow-hidden flex flex-col shadow-xl">
                 <div className="h-6 border-b border-[#0C0C14]/5 flex items-center px-2 bg-[#FAFAFA]">
                   <div className="text-[7px] font-mono text-[#0C0C14]/40 uppercase tracking-wider">Prompt</div>
                 </div>
                 <div className="p-3 flex-grow flex flex-col gap-2">
                   <div className="bg-[#4B57DB]/10 text-[#4B57DB] text-[8px] p-1.5 rounded self-end max-w-[80%]">
                     Create a dark mode dashboard.
                   </div>
                   <div className="bg-[#0C0C14]/5 text-[#0C0C14]/70 text-[8px] p-1.5 rounded self-start max-w-[80%]">
                     Generating structure...
                   </div>
                   <div className="flex gap-1 mt-auto">
                     <div className="h-[2px] bg-[#FF7A59] flex-grow rounded-full animate-pulse" />
                     <div className="h-[2px] bg-[#0C0C14]/10 flex-grow rounded-full" />
                   </div>
                 </div>
               </div>
            </div>

            <p className="font-sans text-[#0C0C14]/60 text-sm mt-4 z-10 w-[90%]">
