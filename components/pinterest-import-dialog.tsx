...
function StepBoards({
      ...
      <div className="space-y-3">
        <div className="grid grid-cols-2 gap-2">
          {Array.from({ length: 6 }).map((_, i) => (
            <div
              key={i}
              className="animate-pulse rounded-lg border border-[#1a1a1a] bg-[#111]"
              style={{ height: 112 }}
            />
          ))}
        </div>
    ...
    return (
      <div className="flex flex-col items-center gap-5 py-8 text-center">
        ...
        <button
          type="button"
          onClick={onConnect}
          className="flex items-center gap-2 rounded-md bg-[#E60023] px-5 py-2.5 text-sm font-medium text-white transition-opacity hover:opacity-90"
        >
  ...
  if (error) {
    return (
      <p className="rounded-md border border-red-500/30 bg-red-500/10 px-3 py-2.5 text-sm text-red-400">
        {error}
      </p>
    );
  }
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between border-t border-[#1a1a1a] pt-3">
        ...
        <button
          ...
          className="rounded-md bg-white px-4 py-2 text-[12px] font-medium text-black transition-opacity disabled:cursor-not-allowed disabled:opacity-30 hover:opacity-80"
        >
          Continue
        </button>
      </div>
...
function StepDestination({
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-lg border border-[#1a1a1a] bg-[#0a0a0a] px-3.5 py-3">
      ...
      <div className="flex items-center justify-between border-t border-[#1a1a1a] pt-3">
        ...
        <button
          ...
          className="rounded-md bg-[#E60023] px-4 py-2 text-[12px] font-medium text-white transition-opacity disabled:cursor-not-allowed disabled:opacity-30 hover:opacity-90"
        >
          Import to Vision
        </button>
      </div>
  ...
  return (
    <div className="flex flex-col items-center gap-6 py-8 text-center">
      ...
      <button
        type="button"
        onClick={onClose}
        className="rounded-md border border-[#333] bg-[#111] px-5 py-2 text-[12px] font-medium text-white transition-colors hover:border-white/20"
      >
        Close
      </button>
    </div>
