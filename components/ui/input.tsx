  ...
  ({ className, type = "text", error, ...props }, ref) => {
    return (
      <input
        ...
        type={type}
        className={cn(
          "flex h-10 w-full rounded-[2px] border bg-bg-input px-3 py-2",
          ...
          error
            ...
            : "border-border-primary bg-white focus:border-[var(--accent-pill)] focus:shadow-[0_0_0_3px_rgba(209,228,252,0.5)]",
